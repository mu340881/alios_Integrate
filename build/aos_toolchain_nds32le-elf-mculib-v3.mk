ifneq ($(filter $(HOST_ARCH), ANDES_N9),)

TOOLCHAIN_PATH ?=
TOOLCHAIN_PREFIX  := nds32le-elf-
TOOLCHAIN_DEFAULT_FOLDER := nds32le-elf-mculib-v3
...
ADD_COMPILER_SPECIFIC_STANDARD_CFLAGS   = $(1) -fno-common 
ADD_COMPILER_SPECIFIC_STANDARD_CXXFLAGS = $(1) -fno-common -fno-rtti -fno-exceptions  
