...
#define D11_MAX_TID			8
#define D11_TID_MASK	    0x0007
...
typedef struct D11_HEADER_S {
	union ALL_HDRS {
		...
		PACKED struct HDR_ADDBA_REQ_ALIGN {
			...
			uint8 Elts[1];
		} GCC_PACKED  HDR_ADDBA_REQ_ALIGN;
		PACKED struct HDR_ADDBA_RESP_ALIGN {
			...
			uint8 BaTimeoutMsb;
			uint8 Elts[1];
		} GCC_PACKED  HDR_ADDBA_RESP_ALIGN;
		PACKED struct HDR_ACTION_CHW_NOTIFY {
			uint16 FrameCtl;
			uint16 Duration;
			D0_ADDR DA;
			D0_ADDR SA;
			...
			uint8 Action;
			uint8 Chw;
		} GCC_PACKED  HDR_ACTION_CHW_NOTIFY;
		...
		} GCC_PACKED  HDR_CTRL_WRAPPER;
	} u;
}GCC_PACKED D11_HEADER;
...
#define D11_MAX_BEACON_SIZE		 700
...
#define D11_RTS_THRESHOLD		   1000	/* was 2347*/
#define D11_MAX_RECEIVE_LIFETIME	    512
#define D11_MAX_TRANSMIT_MSDU_LIFETIME      256
#define D11_MAX_TRANSMIT_SHORT_LIFETIME      256
#define D11_MAX_TRANSMIT_LONG_LIFETIME      500
#define D11_SHORT_RETRY_LIMIT	    11
#define D11_LONG_RETRY_LIMIT		10
