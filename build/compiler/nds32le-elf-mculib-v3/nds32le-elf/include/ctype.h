...
#define	isalpha(__c)	(__ctype_lookup((int)__c)&(_U|_L))
#define	isupper(__c)	((__ctype_lookup((int)__c)&(_U|_L))==_U)
#define	islower(__c)	((__ctype_lookup((int)__c)&(_U|_L))==_L)
#define	isdigit(__c)	(__ctype_lookup((int)__c)&_N)
#define	isxdigit(__c)	(__ctype_lookup((int)__c)&(_X|_N))
#define	isspace(__c)	(__ctype_lookup((int)__c)&_S)
#define ispunct(__c)	(__ctype_lookup((int)__c)&_P)
#define isalnum(__c)	(__ctype_lookup((int)__c)&(_U|_L|_N))
#define isprint(__c)	(__ctype_lookup((int)__c)&(_P|_U|_L|_N|_B))
#define	isgraph(__c)	(__ctype_lookup((int)__c)&(_P|_U|_L|_N))
#define iscntrl(__c)	(__ctype_lookup((int)__c)&_C)
