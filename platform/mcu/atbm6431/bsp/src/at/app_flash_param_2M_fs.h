...
#define FLASH_BOOT_PARAM_SECTION2_ADDR		(FLASH_BASE+0xC0000)  /*struct flash_ap_config_section*/
#define FLASH_USR_KEY_SECTION_ADDR			(FLASH_BASE+0xC1000)  /*user key*/
#define FLASH_USR_KEY_SECTION_LEN			(0x1000)  /*user key len*/
#define FLASH_USR_DATA_SECTION_ADDR 		(FLASH_BASE+0xC2000)  /*user data1*/
#define FLASH_USR_DATA_SECTION_LEN          (0xA000)
#define FLASH_USR_DATA_SECTION2_ADDR		(FLASH_BASE+0xCC000)  /*user data2*/
#define FLASH_USR_DATA_SECTION2_LEN         (0x4000)
#define FLASH_CODE1_UPDATA_SECTION_ADDR		(FLASH_BASE+0xD0000)  /* FLASH_CODE1*/
...
#define IOT_MAX_SSFS_SIZE      				(0x200000-FLASH_CODE2_UPDATA_SECTION_END_ADDR)
