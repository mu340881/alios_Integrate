...
extern int memcmp(const void *dest, const void *src, size_t count);
...
extern char* strnstr(const char* buffer, const char* token, unsigned int n);

/** Like strstr but does not need 'buffer' to be NULL-terminated */
extern  char* strrnstr(const char* buffer, const char* token, unsigned int n);
