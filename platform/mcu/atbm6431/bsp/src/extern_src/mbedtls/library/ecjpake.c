 ...
 * Initialize context
 */
FLASH_FUNC void mbedtls_ecjpake_init( mbedtls_ecjpake_context *ctx )
{
    if( ctx == NULL )
        return;
 ...
 * Free context
 */
FLASH_FUNC void mbedtls_ecjpake_free( mbedtls_ecjpake_context *ctx )
{
    if( ctx == NULL )
        return;
 ...
 * Setup context
 */
FLASH_FUNC int mbedtls_ecjpake_setup( mbedtls_ecjpake_context *ctx,
 ...
 */
FLASH_FUNC int mbedtls_ecjpake_check( const mbedtls_ecjpake_context *ctx )
{
    if( ctx->md_info == NULL ||
 ...
 */
FLASH_FUNC static int ecjpake_write_len_point( unsigned char **p,
 ...
 */
FLASH_FUNC static int ecjpake_hash( const mbedtls_md_info_t *md_info,
                         const mbedtls_ecp_group *grp,
                         const int pf,
 ...
 */
FLASH_FUNC static int ecjpake_zkp_read( const mbedtls_md_info_t *md_info,
                             const mbedtls_ecp_group *grp,
                             const int pf,
                             const mbedtls_ecp_point *G,
                             const mbedtls_ecp_point *X,
 ...
 */
FLASH_FUNC static int ecjpake_zkp_write( const mbedtls_md_info_t *md_info,
                              const mbedtls_ecp_group *grp,
                              const int pf, 
                              const mbedtls_ecp_point *G,
                              const mbedtls_mpi *x,
 ...
 */
FLASH_FUNC static int ecjpake_kkp_read( const mbedtls_md_info_t *md_info,
                             const mbedtls_ecp_group *grp,
                             const int pf,
                             const mbedtls_ecp_point *G,
                             mbedtls_ecp_point *X,
 ...
 */
FLASH_FUNC static int ecjpake_kkp_write( const mbedtls_md_info_t *md_info,
                              const mbedtls_ecp_group *grp,
                              const int pf,
                              const mbedtls_ecp_point *G,
                              mbedtls_mpi *x,
 ...
 */
FLASH_FUNC static int ecjpake_kkpp_read( const mbedtls_md_info_t *md_info,
                              const mbedtls_ecp_group *grp,
                              const int pf,
                              const mbedtls_ecp_point *G,
 ...
 */
FLASH_FUNC static int ecjpake_kkpp_write( const mbedtls_md_info_t *md_info,
                               const mbedtls_ecp_group *grp,
                               const int pf,
                               const mbedtls_ecp_point *G,
                               mbedtls_mpi *xm1,
 ...
 */
FLASH_FUNC int mbedtls_ecjpake_read_round_one( mbedtls_ecjpake_context *ctx,
                                    const unsigned char *buf,
                                    size_t len )
{
 ...
 */
FLASH_FUNC int mbedtls_ecjpake_write_round_one( mbedtls_ecjpake_context *ctx,
 ...
 */
FLASH_FUNC static int ecjpake_ecp_add3( mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
 ...
 */
FLASH_FUNC int mbedtls_ecjpake_read_round_two( mbedtls_ecjpake_context *ctx,
                                            const unsigned char *buf,
                                            size_t len )
{
    int ret;
 ...
 */
FLASH_FUNC static int ecjpake_mul_secret( mbedtls_mpi *R, int sign,
                               const mbedtls_mpi *X,
                               const mbedtls_mpi *S,
                               const mbedtls_mpi *N,
                               int (*f_rng)(void *, unsigned char *, size_t),
 ...
 */
FLASH_FUNC int mbedtls_ecjpake_write_round_two( mbedtls_ecjpake_context *ctx,
                            unsigned char *buf, size_t len, size_t *olen,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng )
{
 ...
 */
FLASH_FUNC int mbedtls_ecjpake_derive_secret( mbedtls_ecjpake_context *ctx,
                            unsigned char *buf, size_t len, size_t *olen,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng )
{
...
FLASH_FUNC int mbedtls_ecjpake_self_test( int verbose )
{
    (void) verbose;
    return( 0 );
}
...
FLASH_FUNC static int ecjpake_test_load( mbedtls_ecjpake_context *ctx,
...
FLASH_FUNC static int ecjpake_lgc( void *p, unsigned char *out, size_t len )
{
