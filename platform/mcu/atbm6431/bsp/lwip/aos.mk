...
include platform/mcu/atbm6431/bsp/lwip/Filelists.mk
...
$(NAME)_SOURCES += bsp/lwip/port/sys_arch.c
$(NAME)_SOURCES += bsp/lwip/netif/ethernetif.c

ifeq (y,$(AF_PACKET_ENABLED))
#define LWIP_PACKET  1
$(NAME)_SOURCES += bsp/lwipcore/af_packet.c
endif
